  ...
  return {
    ...
    execute: function () {
      ...
      _export("BlockFactory", BlockFactory = (_dec = ccclass('BlockFactory'), _dec(_class = class BlockFactory {
        ...
        createMap(id) {
          var pivotX = this.mapSetting.centerPivotX - this.mapSetting.maxRow / 2;
          var pivotY = this.mapSetting.centerPivotY - this.mapSetting.maxCol / 2;
...
//# sourceMappingURL=207061b80e646eaee068452c15cb65d85a3055e1.js.map