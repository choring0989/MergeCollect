    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        setTilePosition(item) {
          var x = Math.min(Math.round(item.hitPoint.x), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
          }), IngameManager) : IngameManager).mapSetting.maxRow / 2);
          var z = Math.min(Math.round(item.hitPoint.z), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
          }), IngameManager) : IngameManager).mapSetting.maxCol / 2);

          if (x < (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
          }), IngameManager) : IngameManager).mapSetting.startRow) {
            x = (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
              error: Error()
            }), IngameManager) : IngameManager).mapSetting.startRow;
          }

          if (z < (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
          }), IngameManager) : IngameManager).mapSetting.startCol) {
            z = (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
              error: Error()
            }), IngameManager) : IngameManager).mapSetting.startCol;
          }
...
//# sourceMappingURL=38c5f52ab61e6b8795772e8fcc12dac1839effc5.js.map