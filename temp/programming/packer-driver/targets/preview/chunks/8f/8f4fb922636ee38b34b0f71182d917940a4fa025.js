    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        setTilePosition(item) {
          ...
          var z = Math.min(Math.round(item.hitPoint.y), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
...
//# sourceMappingURL=8f4fb922636ee38b34b0f71182d917940a4fa025.js.map