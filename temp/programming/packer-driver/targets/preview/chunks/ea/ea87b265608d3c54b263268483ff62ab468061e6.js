  ...
  return {
    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        move(event) {
          var originPosition = this.node.getWorldPosition();
          var newPosition = event.getLocation();
          this.node.setPosition(newPosition.x / 10, originPosition.y, newPosition.y / 10);
        }
...
//# sourceMappingURL=ea87b265608d3c54b263268483ff62ab468061e6.js.map