    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        setTilePosition(item) {
          const x = Math.min(Math.round(item.hitPoint.x), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
          }), IngameManager) : IngameManager).mapSetting.maxRow);
          const z = Math.min(Math.round(item.hitPoint.y), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
...
//# sourceMappingURL=a65b6dcf64b933666403868ffc73974cad028972.js.map