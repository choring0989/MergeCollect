    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        setTilePosition(item) {
          ...
          const z = Math.min(Math.round(item.hitPoint.z), (_crd && IngameManager === void 0 ? (_reportPossibleCrUseOfIngameManager({
            error: Error()
...
//# sourceMappingURL=ad5cfef266ff75e06b3e20493138d19ed44ca77b.js.map