System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, geometry, input, Input, PhysicsSystem, tween, IngameManager, _dec, _class, _crd, ccclass, property, Coin;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventTouch', 'geometry', 'input', 'Input', 'PhysicsSystem', 'physics', 'tween']);
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        onMove(event) {
          this.raycast(event, this.drag);
        }

        onTouchEnd(event) {
          this.raycast(event, this.setTilePosition);
        }
        ...
        setTilePosition(item) {
          tween().target(this.node.position).to(0.5, {
            x: Math.round(item.hitPoint.x),
            z: Math.round(item.hitPoint.z)
          });
        }
...
//# sourceMappingURL=ea770ddc985e8999f5d8da1648a5d2fbd4b3dae1.js.map