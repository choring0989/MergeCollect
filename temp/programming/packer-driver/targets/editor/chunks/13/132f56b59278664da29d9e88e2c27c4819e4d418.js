        ...
        createMap(id) {
          ...
          for (let i = 0; i < currentMap.row; i++) {
            for (let j = 0; j < currentMap.col; j++) {
              ...
              if (blockData[1] && blockData[1] === k) {
                const block = (_crd && ObjectFactory === void 0 ? (_reportPossibleCrUseOfObjectFactory({
                  error: Error()
                }), ObjectFactory) : ObjectFactory).get(blockData[0]);
                block.setPosition(pivotX + i, pivotY + j, 0);
...
//# sourceMappingURL=132f56b59278664da29d9e88e2c27c4819e4d418.js.map